...
echo ""
echo "=============================================="
echo "  TODO: CONECTAR APP NO RDS POSTGRESQL"
echo "=============================================="
echo ""
echo "O RDS PostgreSQL ja existe em aws/eks_rds/modules/rds/"
echo "mas a app api-pedidos AINDA NAO consome ele."
echo ""
echo "IDEIAS para implementar:"
echo ""
echo "  1. Adicionar env vars no Deployment:"
echo "     DB_HOST, DB_PORT, DB_NAME, DB_USER, DB_PASS"
echo ""
echo "  2. No app.py importar psycopg2 e conectar:"
echo '     conn = psycopg2.connect(host=DB_HOST, ...)'
echo ""
echo "  3. Criar tabela pedidos automaticamente:"
echo "     CREATE TABLE IF NOT EXISTS pedidos (...)"
echo ""
echo "  4. ATUALIZAR endpoints para usar SELECT/INSERT:"
echo "     GET  /api/pedidos     -> SELECT * FROM pedidos"
echo "     GET  /api/pedidos/:id -> SELECT WHERE id=:id"
echo "     POST /api/checkout    -> INSERT INTO pedidos"
echo ""
echo "  5. Criar POST /api/seed?qtd=100 para popular dados"
echo ""
echo "  6. Beneficio para Observabilidade:"
echo "     - Traces com spans do banco (SELECT, INSERT)"
echo "     - Logs com queries executadas"
echo "     - Dashboard com total de pedidos, pedidos/dia"
echo ""
